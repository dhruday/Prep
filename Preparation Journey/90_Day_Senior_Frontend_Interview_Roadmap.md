# 🚀 90-Day Senior Frontend Engineer Interview Preparation Roadmap
### For Big Tech: Google · Meta · Microsoft · Stripe · Netflix · Airbnb · Uber · Adobe · Cisco · Qualcomm · Salesforce

---

> **Your Single Source of Truth for the Next 90 Days**
> Built for an 8+ year Senior Frontend Engineer targeting Senior/Staff roles at top product companies.
> Decision-making is eliminated. Open this document every day and execute.
...
3. [Interview Readiness Overview](#interview-readiness-overview)
4. [Phase Overview](#phase-overview)
5. [Weekly Goals Summary](#weekly-goals-summary)
6. [Phase 1: Foundation Fortification (Days 1–21)](#phase-1-foundation-fortification-days-121)
7. [Phase 2: System Design & Architecture (Days 22–45)](#phase-2-system-design--architecture-days-2245)
8. [Phase 3: Advanced Topics & Mock Interviews (Days 46–70)](#phase-3-advanced-topics--mock-interviews-days-4670)
9. [Phase 4: Peak Performance & Final Push (Days 71–90)](#phase-4-peak-performance--final-push-days-7190)
10. [Revision Master Plan](#revision-master-plan)
11. [Mock Interview Schedule](#mock-interview-schedule)
12. [Interview Readiness Tracker](#interview-readiness-tracker)
13. [Confidence Tracker](#confidence-tracker)
14. [Progress Tracker](#progress-tracker)
15. [Emergency Prep (If Interview Called Tomorrow)](#emergency-prep-if-interview-called-tomorrow)
...
As a Hiring Committee member at Big Tech, I've seen hundreds of engineers fail not because they lacked knowledge — but because they prepared topics in the wrong order, left system design too late, or crammed behavioral prep in the final week.

This roadmap is built on three principles:

**1. Interview Readiness From Day 1**
By Day 10, you will be able to walk into a frontend interview and perform competently. Every subsequent day makes you sharper. There is no "cliff" where readiness suddenly jumps.

**2. Spiral Learning**
Topics aren't studied once and abandoned. Core concepts (JavaScript internals, rendering performance, system design) resurface multiple times across 90 days — each time at greater depth. Spaced repetition is baked in.

**3. Senior-Level Framing**
At L5/L6, interviewers don't want you to list features — they want to see *judgment*. Every day's agenda is framed around the question: "How would a Staff Engineer explain this trade-off?"

### The Interview Types You Will Face

| Interview Round | Frequency | Weight |
|---|---|---|
| JavaScript Deep Dive / Fundamentals | Every company | Very High |
| Frontend System Design | Google, Meta, Microsoft, Stripe, Airbnb | Very High |
| Coding (DSA — Frontend flavor) | All companies | High |
| UI / Component Design | Meta, Airbnb, Stripe, Adobe | High |
| Performance & Optimization | Netflix, Google, Uber | High |
| Behavioral / Leadership | All companies | High |
| Cross-functional / Architecture | Staff-level positions | Medium-High |
...
3. Read the "Why it matters" section
4. Execute the agenda in order
5. End with the Interview Practice questions
6. Mark the day complete in the Progress Tracker

Every Sunday:
1. Complete the Weekly Review Checkpoint
2. Update your Interview Readiness Score
3. Identify your weakest area
4. Minor adjustments only — trust the plan
```
...
│  DAILY STUDY SESSION                                        │
├─────────────────────────────────────────────────────────────┤
│  0:00 – 0:05  │  Warm-up: Review previous day's key points │
│  0:05 – 0:45  │  Primary topic (deep study + notes)        │
│  0:45 – 0:55  │  Hands-on: code / diagram / design sketch  │
│  0:55 – 1:15  │  Interview Practice Questions (attempt)    │
│  1:15 – 1:20  │  Log learning, rate confidence 1–10        │
└─────────────────────────────────────────────────────────────┘
```
...
Update this table every Sunday. Be honest with yourself.

| Domain | Baseline | Day 30 Target | Day 60 Target | Day 90 Target |
|---|---|---|---|---|
| JS Internals & Engine | — | 70% | 85% | 95% |
| Browser Rendering Pipeline | — | 65% | 82% | 95% |
| Frontend System Design | — | 55% | 82% | 95% |
| Performance & Optimization | — | 62% | 85% | 95% |
| React / Framework Deep Dive | — | 75% | 90% | 95% |
| Coding (DSA + DOM) | — | 60% | 80% | 90% |
| Security & Accessibility | — | 50% | 78% | 90% |
| Behavioral / Leadership | — | 70% | 85% | 95% |
| **Overall Readiness** | **—** | **65%** | **82%** | **95%** |
...
```
╔══════════════════════════════════════════════════════════════════╗
║  PHASE 1  │  Days  1–21  │  Foundation Fortification            ║
║           │              │  JS internals, browser pipeline,      ║
║           │              │  React, CSS, coding basics           ║
║           │              │  Readiness: 0% → 65%                 ║
╠══════════════════════════════════════════════════════════════════╣
║  PHASE 2  │  Days 22–45  │  System Design & Architecture        ║
║           │              │  Frontend system design, scalability, ║
║           │              │  API design, component architecture   ║
║           │              │  Readiness: 65% → 80%                ║
╠══════════════════════════════════════════════════════════════════╣
║  PHASE 3  │  Days 46–70  │  Advanced Topics & Mock Interviews   ║
║           │              │  Performance, security, testing,      ║
║           │              │  accessibility, mock interview loops  ║
║           │              │  Readiness: 80% → 90%                ║
╠══════════════════════════════════════════════════════════════════╣
║  PHASE 4  │  Days 71–90  │  Peak Performance & Final Push       ║
║           │              │  Full mock loops, behavioral mastery, ║
║           │              │  final revision, mental readiness     ║
║           │              │  Readiness: 90% → 95%+               ║
╚══════════════════════════════════════════════════════════════════╝
```
...
| Week | Days | Primary Focus | Readiness Target |
|---|---|---|---|
| Week 1 | 1–7 | JS Engine, Event Loop, Closures, Prototypes, `this` | 40% |
| Week 2 | 8–14 | Browser Rendering, CSS Internals, DOM APIs | 50% |
| Week 3 | 15–21 | React Deep Dive, Hooks, Patterns, Coding Basics | 65% |
| Week 4 | 22–28 | Frontend System Design Foundations | 70% |
| Week 5 | 29–35 | System Design: News Feed, Autocomplete, Design Systems | 75% |
| Week 6 | 36–42 | System Design: Video Player, Real-time Apps, E-Commerce | 78% |
| Week 7 | 43–49 | Performance Deep Dive + First Full Mock Interview | 82% |
| Week 8 | 50–56 | Security, Accessibility, TypeScript, Testing Strategy | 84% |
| Week 9 | 57–63 | Advanced Patterns + Second Full Mock Interview | 87% |
| Week 10 | 64–70 | Build Tools, Node/BFF, Monorepos + Third Full Mock | 90% |
| Week 11 | 71–77 | Behavioral Mastery + Coding Sprint | 92% |
| Week 12 | 78–84 | Comprehensive Revision + Mock Interview Loops | 94% |
| Week 13 | 85–90 | Final Polish, Weak Spot Elimination, Peak Readiness | 95%+ |
...
- Turborepo remote caching and distributed builds
- Nx affected commands and incremental computation
- Changesets for package versioning in monorepos
- GitHub Actions: matrix builds, caching strategies, reusable workflows
- Preview deployments: Vercel, Netlify deploy previews in CI
- Dependency graph analysis: why circular deps are deadly
- Publishing to npm from a monorepo
- Private package registries

**Hands-on (15 min)**
Write a GitHub Actions workflow that:
1. Runs only affected package tests
...
1. **(Hard | Google, Meta)** Design the complete CI/CD pipeline for a monorepo with 30 packages, 5 apps, and 200+ engineers. How do you keep CI under 10 minutes?

2. **(Medium | All Companies)** What is "remote caching" in Turborepo? How does it share build artifacts between CI runs and developer machines?

3. **(Hard | Stripe, Adobe)** How do you handle breaking changes in a monorepo shared component library? Walk through the changesets workflow.

4. **(Medium | Google, Netflix)** What is a "task graph" in Turborepo/Nx? How does it parallelize builds correctly?

5. **(Hard | Meta, Microsoft)** Design the dependency architecture for a design system monorepo. How do you prevent circular dependencies?

6. **(Medium | All Companies)** What is a private npm registry? When would you use one vs a public registry?

7. **(Hard | Stripe, Netflix)** How do you implement blue-green deployments for a frontend application? What does the switching mechanism look like?

8. **(Medium | Google, Adobe)** What is a "reusable workflow" in GitHub Actions? Implement one for frontend testing that can be shared across repositories.

9. **(Hard | Meta, Airbnb)** How do you enforce architectural rules (no cross-domain imports, required peer dependencies) automatically in CI?

10. **(Medium | All Companies)** What is "semantic-release"? How does it automate versioning and publishing based on conventional commits?
...
- Node.js performance: event loop blocking, profiling with `clinic.js`
- Streams and backpressure: when producers outpace consumers
- Cluster vs Worker Threads: use cases for each
- Express middleware patterns: error handling, authentication middleware
- Fastify vs Express: performance characteristics
- Next.js API routes vs standalone Express BFF
- tRPC for type-safe full-stack development
- BFF authentication patterns: token forwarding, session management
- Connection pooling to databases in a serverless environment
- Graceful shutdown: SIGTERM handling, draining in-flight requests

**Hands-on (10 min)**
Implement a BFF endpoint that:
1. Authenticates the request (JWT validation)
2. Calls 3 downstream services in parallel
3. Times out if any service takes >2s
4. Returns a merged response with partial data on timeout

---

**📝 Day 65 Interview Practice Questions**

1. **(Hard | Netflix, Uber)** Design a BFF for a mobile app that aggregates 8 microservices. How do you handle: fan-out, partial failures, circuit breaking, and caching?

2. **(Medium | All Companies)** What is backpressure in Node.js streams? Implement a streaming file upload that respects backpressure.

3. **(Hard | Google, Stripe)** How do you implement graceful shutdown in a Node.js HTTP server? Why is it critical for zero-downtime deployments?

4. **(Medium | Meta, Adobe)** What is tRPC? How does it provide end-to-end type safety without code generation?

5. **(Hard | Netflix, Uber)** Implement a circuit breaker pattern in Node.js that opens after 5 consecutive failures and resets after 30 seconds.

6. **(Medium | Google, Stripe)** How does connection pooling work in a serverless Node.js environment (Lambda/Vercel Functions)? What problems arise?

7. **(Hard | Meta, Airbnb)** Implement a request deduplication middleware for a BFF that caches identical concurrent requests.

8. **(Medium | All Companies)** What is the difference between `async_hooks` and OpenTelemetry for distributed tracing in Node.js?

9. **(Hard | Netflix)** Design the logging architecture for a high-traffic BFF: structured logs, correlation IDs, sampling strategy, and privacy compliance.

10. **(Medium | Stripe, Adobe)** How do you implement rate limiting per user in a Node.js BFF using Redis? Walk through the token bucket algorithm.

---

### DAY 66 — Coding Sprint: Hard Problems Under Time Pressure

**Study Agenda (75 min — pure coding, no notes)**

Rules: No looking anything up. Set a timer. Write clean code with comments.

**Problems (20 min each, pick 3):**

1. Implement a `throttle` function that supports leading and trailing edge execution with cancellation.

2. Implement a simplified React reconciler that processes a `VNode` tree and produces DOM operations (insert, update, delete).

3. Implement an LRU cache with TTL support and a `clear(pattern)` method that clears all keys matching a glob pattern.

4. Implement `Promise.any` and `Promise.allSettled` from scratch, including correct error handling.

5. Implement a `deepMerge(target, source)` function that handles arrays, objects, and primitive values with configurable array merge strategies.

---

**📝 Day 66 Interview Practice Questions**

1. **(Hard)** Implement `deepMerge` where arrays are concatenated by default but can be overridden to replace.
2. **(Hard)** Implement a simplified virtual DOM diff that outputs a patch object.
3. **(Hard)** Implement a `retry(fn, options)` where options include max attempts, delay, backoff strategy, and a `shouldRetry(error)` predicate.
4. **(Hard)** Implement a tagged template literal `css\`color: ${primary}\`` that returns a style object.
5. **(Hard)** Implement a `createSignal` function (SolidJS-style) that creates a reactive value with getter and setter.
6. **(Medium)** Implement `Object.keys`, `Object.values`, `Object.entries`, and `Object.fromEntries` from scratch.
7. **(Hard)** Implement a function that converts a flat list with `parent_id` fields into a nested tree structure in O(n).
8. **(Medium)** Implement `Array.prototype.flatMap` from scratch.
9. **(Hard)** Implement a `Scheduler` class that runs tasks with priorities (high/medium/low) without blocking the main thread.
10. **(Hard)** Implement a miniature Zustand: `createStore(initialState)` with `getState`, `setState`, `subscribe`, and selector support.
...
Design from scratch: **"Design a Real-Time Analytics Dashboard (like Datadog/Mixpanel)"**

- Data ingestion pipeline (frontend-only perspective)
- Chart types: line, bar, scatter, heatmap — implementation considerations
- Real-time data updates: WebSocket vs SSE vs polling
- Time range selection and granularity
- Data aggregation on the client vs server
- Canvas vs SVG for chart rendering at scale
- Virtualization for large data sets (thousands of data points)
- Export functionality: CSV, PNG/PDF
- Alerting UI: threshold lines, anomaly highlighting
- Dashboard layout: drag-and-drop widget placement, persistence
- Responsive design: desktop-first vs mobile considerations

---

**📝 Day 67 Interview Practice Questions**

1. **(Hard | Stripe, Salesforce)** Design an analytics dashboard for a SaaS product. How do you handle: real-time data, time range filtering, and rendering 10,000-point line charts?

2. **(Medium | Google, Adobe)** When would you use SVG vs Canvas for chart rendering? What's the crossover point in data volume?

3. **(Hard | Netflix, Stripe)** Implement a real-time line chart that updates every second with new data points and smoothly animates transitions.

4. **(Medium | All Companies)** How do you implement a drag-and-drop dashboard layout that persists widget positions to the server?

5. **(Hard | Salesforce, Meta)** Design the frontend architecture for a dashboard that can display 50 widgets, each with independent data fetching, real-time updates, and error states.

6. **(Medium | Stripe, Google)** How do you implement a time range selector (last 1h, 24h, 7d, custom) that synchronizes across all charts on the page?

7. **(Hard | Netflix, Adobe)** Implement chart data downsampling — when the user has 1M data points but the chart only has 1000 pixels wide, how do you intelligently reduce the data?

8. **(Medium | Salesforce)** How do you export a canvas-rendered chart as a PNG without a server round-trip?

9. **(Hard | Stripe)** Design the alert system UI: visual threshold indicators, anomaly detection markers, and notification delivery for a monitoring dashboard.

10. **(Medium | Google, Meta)** What are the performance considerations when rendering 50 charts simultaneously on one page? How do you virtualize off-screen charts?

---

### DAY 68 — Behavioral Interview Mastery: Stories and Frameworks

**Why it matters:** Behavioral interviews are weighted equally to technical at Google, Meta, and Microsoft. Engineers who prepare stories in advance and structure them clearly consistently outperform those who freestyle. This isn't soft prep — it's strategic.

**Study Agenda (75 min)**

**Part 1 — The STAR-L Framework (20 min)**

Every behavioral answer must include:
- **S**ituation: set the context briefly
- **T**ask: what were you specifically responsible for?
- **A**ction: what did YOU do (not the team)?
- **R**esult: quantified outcomes where possible
- **L**earning: what changed in how you work because of this?

**Part 2 — Story Bank Preparation (45 min)**

Write detailed notes for one story per category:

1. **Technical Leadership:** A time you made a major architecture decision
2. **Conflict Resolution:** A technical disagreement with a peer or manager
3. **(Wrong Decision):** A time you made a call that was wrong
4. **Influence Without Authority:** Getting adoption for a technical change without mandate
5. **Ambiguity:** Working effectively without clear requirements
6. **Prioritization:** Choosing between competing technical priorities
7. **Mentorship:** Growing a junior engineer
8. **Failure and Recovery:** A project that failed or nearly failed
9. **Cross-functional Collaboration:** Working with design, product, data
10. **Scale:** Solving a problem that required thinking about millions of users

**Part 3 — Company-Specific Values (10 min)**

Research and internalize:
- Google: Googliness, Technical Leadership, Effective Communication
- Meta: Move Fast, Be Bold, Build Social Value
- Microsoft: Growth Mindset, Diversity and Inclusion
...
*Practice answering each of these out loud (not just in your head). Record if possible.*

1. **(Google)** Tell me about a time you had to influence engineers across multiple teams to adopt a new technical standard. How did you get buy-in?

2. **(Meta)** Tell me about the most technically complex problem you've shipped. What made it complex and how did you break it down?

3. **(Microsoft)** Describe a situation where you received critical feedback that changed how you work. How did you respond?

4. **(All Companies)** Tell me about a time a project you were leading was at risk of failing. What did you do?

5. **(Google, Meta)** Tell me about a technical decision you made that turned out to be wrong. How did you handle it?

6. **(Meta, Airbnb)** How do you decide what technical debt to pay down vs what features to ship?

7. **(Google)** Give me an example of when you had to make a decision with incomplete information. What was your process?

8. **(All Companies)** Tell me about a time you had a significant disagreement with a senior colleague. How did it resolve?

9. **(Meta, Stripe)** Tell me about the most impactful technical contribution you've made in your career.

10. **(Google, Microsoft)** How have you grown junior engineers on your team? Give a specific example.

11. **(Airbnb, Netflix)** Tell me about a time you improved the developer experience or engineering culture of your team.

12. **(Stripe)** Describe a time when you prioritized long-term system health over short-term feature delivery. What was the outcome?
...
These are "implement what you just designed" coding problems — common in interviews where the design round bleeds into the coding round.

**Problems (pick 3, 20 min each):**

1. You designed an autocomplete — now implement the debounce + caching layer
2. You designed a real-time chat — now implement the WebSocket reconnection manager
3. You designed a virtual list — now implement it with dynamic row heights
4. You designed a state management system — now implement a simple Redux from scratch
5. You designed a design token system — now implement a theme provider using CSS variables + React Context

---

**📝 Day 69 Interview Practice Questions**

1. **(Hard)** Implement `createRedux`: `createStore(reducer, initialState)` with `getState`, `dispatch`, `subscribe`, and middleware support (`applyMiddleware`).

2. **(Hard)** Implement a WebSocket reconnection manager with exponential backoff, message queuing, and event emitter for connection state changes.

3. **(Hard)** Implement a `ThemeProvider` that injects CSS variables and supports nested theme overrides.

4. **(Hard)** Implement an `InfiniteQuery` hook (React Query style) with cursor-based pagination, background refetch, and error recovery.

5. **(Hard)** Implement a virtual scroller with: dynamic heights, correct scrollbar, keyboard navigation, and accessibility.

6. **(Medium)** Implement `createSignal` and `createEffect` (SolidJS-style reactivity) from scratch.

7. **(Hard)** Implement a request queue that serializes concurrent API calls to the same resource but deduplicates identical requests.

8. **(Medium)** Implement a form validation engine: `createForm(config)` where config maps field names to validation rules.

9. **(Hard)** Implement a middleware pipeline: `createMiddleware([fn1, fn2, fn3])` where each middleware can modify the request and call next.

10. **(Hard)** Implement `createElement` and `render` for a simplified React-like library that handles: function components, props, children, and basic state.

---

### DAY 70 — FOURTH FULL MOCK INTERVIEW + Phase 3 Assessment

**Full Mock Loop (simulate 3 rounds, 2.5 hours total)**

**Round 1 — Coding (45 min):**
> Implement a `useFormWithValidation` hook in TypeScript that: manages field state, validates on blur, cross-validates fields, submits with async validation, and exposes a clean API.

**Round 2 — System Design (45 min):**
> "Design the frontend for Stripe's payment dashboard — a page showing transactions, charts, and real-time payment events. Handle: 10K TPS during peak, large data tables, real-time updates, and export functionality."

**Round 3 — Behavioral (30 min):**
1. Tell me about a time you drove a significant technical migration (e.g., class components to hooks, Webpack to Vite).
2. How do you handle a situation where product wants to ship something technically risky?
3. What's the biggest technical risk in your current codebase and what would you do about it?

**Phase 3 Assessment:**
Rate yourself 1–10 on every major topic. Create a "final 20 days" priority list of your weakest areas.

---

**📝 Day 70 Interview Practice Questions (Self-Assessment Focus)**

1. Score each technical domain 1-10: JS Internals / Browser / React / System Design / Coding / Performance / Security / A11y / TypeScript / Behavioral

2. Which 3 topics would cause you to fail an interview right now?

3. In your last mock, what question stumped you most? Research the answer now.

4. Are your behavioral stories rehearsed enough to tell them naturally in under 2 minutes?

5. Do you have a complete answer to "Tell me about yourself" (2 min, covers experience arc, key achievements, and why this company)?

---

## Week 11 (Days 71–77): Behavioral Mastery + Coding Sprint

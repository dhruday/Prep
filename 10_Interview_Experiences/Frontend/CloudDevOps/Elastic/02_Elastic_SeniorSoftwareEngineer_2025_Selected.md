# Elastic — Senior Software Engineer Interview Experience (2025)
...
- **Total Rounds:** 4 (Frontend System Design → Frontend Coding - JS Deep Dive → Architecture Deep Dive + 1 more)
- **Timeline:** 4 weeks

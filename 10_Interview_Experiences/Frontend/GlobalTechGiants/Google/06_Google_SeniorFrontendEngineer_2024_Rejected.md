# Google — Senior Frontend Engineer Interview Experience (2024)
...
- **Total Rounds:** 6 (Architecture Deep Dive → Frontend System Design → Frontend Coding - React/Framework + 3 more)
- **Timeline:** 10 days

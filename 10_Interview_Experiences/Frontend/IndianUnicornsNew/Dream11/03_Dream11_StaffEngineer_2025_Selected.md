# Dream11 — Staff Engineer Interview Experience (2025)
...
- **Total Rounds:** 7 (Low-Level Design → Frontend Coding - React/Framework → Behavioral / LP + 4 more)
...
**Situation:** Led team of 5 at Dream11 to migrate legacy jQuery codebase to React + TypeScript.
...
- Dream11 heavily tests JavaScript fundamentals at the senior level

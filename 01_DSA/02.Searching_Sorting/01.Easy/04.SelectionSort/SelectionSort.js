...
array and placing it at the beginning. The algorithm maintains two subarrays: one that is already
sorted and another that is unsorted.
...
Solution Approaches:
1. Selection Sort: O(n²) time | O(1) space
...
function runTests() {
    testCases.forEach((testCase, index) => {
        const result = selectionSort([...testCase.array]);

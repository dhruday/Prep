# Confluent — Staff Engineer Interview Experience (2025)
...
| **Source** | [Interview Source](https://www.glassdoor.co.in/Interview/Confluent-Interview-Questions-E1147845.htm) |
| **Author** | Anonymous |
...
- **Total Rounds:** 4 (Frontend System Design → DSA Round → Hiring Manager + 1 more)
- **Timeline:** 2 weeks
...
2. **Longest substring without repeats - sliding window**
...
**Situation:** Led team of 5 at Confluent to migrate legacy jQuery codebase to React + TypeScript.
...
- Confluent heavily tests JavaScript fundamentals at the senior level

# Bounce — Staff Engineer Interview Experience (2026)
...
| **Source** | [Interview Source](https://www.glassdoor.co.in/Interview/Bounce-Interview-Questions-E2416893.htm) |
| **Author** | Anonymous |
...
- **Total Rounds:** 7 (Online Assessment → Frontend System Design → Machine Coding + 4 more)
- **Timeline:** 2 weeks
...
3. **structuredClone polyfill for all types**
...
### Questions Asked
1. **File explorer with navigation + search**
...
**Situation:** Led team of 5 at Bounce to migrate legacy jQuery codebase to React + TypeScript.
...
### Questions Asked
1. **Complex nested forms with dynamic fields**
...
- Bounce heavily tests JavaScript fundamentals at the senior level

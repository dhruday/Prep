# ARM — Fellow Interview Experience (2024)
...
| **Source** | [Interview Source](https://www.glassdoor.co.in/Interview/Arm-Interview-Questions-E5765.htm) |
| **Author** | Anonymous |
...
- **Total Rounds:** 6 (DSA Round → Frontend Coding - React/Framework → Hiring Manager + 3 more)
- **Timeline:** 10 days
...
**Situation:** Led team of 5 at ARM to migrate legacy jQuery codebase to React + TypeScript.
...
- ARM heavily tests JavaScript fundamentals at the senior level

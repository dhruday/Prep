# IBM — Senior Frontend Developer Interview Experience (2025)
...
| **Result** | ✅ Selected |
| **Location** | Pune, India |
| **Source** | [Interview Source](https://www.glassdoor.co.in/Interview/IBM-Interview-Questions-E354.htm) |
| **Author** | Anonymous |
...
- **Total Rounds:** 7 (Online Assessment → Architecture Deep Dive → DSA Round + 4 more)
- **Timeline:** 3 weeks
...
**Situation:** Led team of 5 at IBM to migrate legacy jQuery codebase to React + TypeScript.
...
- IBM heavily tests JavaScript fundamentals at the senior level
